...
class ilObjSrVideoInterviewUploadHandlerGUI extends AbstractCtrlAwareUploadHandler
{
    ...
    private $storage;
    /**
     * @var \ILIAS\MainMenu\Storage\Resource\Stakeholder\ResourceStakeholder
     */
    private $stakeholder;
    ...
    public function __construct()
    {
        ...
        $this->stakeholder = new class extends \ILIAS\MainMenu\Storage\Resource\Stakeholder\AbstractResourceStakeholder {
    ...
    protected function getRemoveResult(string $identifier) : HandlerResultInterface
    {
        ...
        if ($id !== null) {
            ...
            return new BasicHandlerResult($this->getFileIdentifierParameterName(), HandlerResultInterface::STATUS_OK,
                $identifier, 'file deleted');
        } else {
    ...
    public function getInfoForExistingFiles(array $file_ids) : array
    {
        ...
        foreach ($file_ids as $file_id) {
            ...
            $infos[] = new BasicFileInfoResult($this->getFileIdentifierParameterName(), $file_id, $r->getTitle(),
                $r->getSize(), $r->getMimeType());
        }
